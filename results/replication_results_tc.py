...
allocations_model = pd.read_excel('results/allocations_30_09.xlsx', sheet_name='Allocations Tc').values

res = benchmark_book.evaluate_all(X_test, allocations_model, X_test_rolling, tc=0.1)
